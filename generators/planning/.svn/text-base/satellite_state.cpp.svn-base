...
int main(int argc, char* argv[])
{
  ...
  cout << "FORALL( i t2 t1 ) EXISTS(s)  ~next[ t1 t2 ] ~powerOn[i t2] powerOn[i t1] onBoard[i s]  { t1 != t2 } ;"  << endl
       ...
       << "FORALL( d m t1 t2 ) EXISTS( i )  ~next[ t1 t2 ] ~haveImage[ d m t2 ] haveImage[ d m t1 ] powerOn[ i t1 ] 	{ t1 != t2 } ;"  << endl
  ...
  cout << "// change of state" << endl
       ...
       << "FORALL( i s d m t1 t2 ) ~next[ t1 t2 ] ~calibrated[ i t1 ] ~onBoard[ i s ] ~supports[ i m ] ~powerOn[ i t1 ] haveImage[ d m t1 ] ~haveImage[ d m t2 ] pointing[ s d t1 ] 	{ t1 != t2 };" << endl
       << "FORALL( i s d m t1 t2 ) ~next[ t1 t2 ] ~calibrated[ i t1 ] ~onBoard[ i s ] ~supports[ i m ] ~powerOn[ i t1 ] haveImage[ d m t1 ] ~haveImage[ d m t2 ] pointing[ s d t2 ] 	{ t1 != t2 };" << endl
